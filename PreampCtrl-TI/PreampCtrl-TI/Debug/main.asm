...
;	C:\ti\ccs1281\ccs\tools\compiler\c6000_7.4.24\bin\acpia6x.exe -@C:\\Users\\User\\AppData\\Local\\Temp\\{BB39C77E-26C4-43C2-B844-C5CA48077DC1} 
	.sect	".text"
	.clink
	.global	main
...
$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("main")
	...
	.dwpsn	file "../main.c",line 7,column 1,is_stmt,address main,isa 0
...
;          EXCLUSIVE CPU CYCLES: 7
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../main.c",line 8,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;   8 | return 0;                                                              
;----------------------------------------------------------------------
           ZERO    .L1     A4                ; |8| 
	.dwpsn	file "../main.c",line 9,column 1,is_stmt,isa 0
	.dwcfi	cfa_offset, 0
$C$DW$2	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$1, DW_AT_TI_end_line(0x09)
...
$C$DW$T$19	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$19, DW_AT_decl_line(0x09)
